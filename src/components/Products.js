...
//       const allCartData=await fetchCart(token);
//       generateCartItemsFrom(allCartData,productsData);
...
//                 product={element}
//                 handleAddToCart={() =>
//                   addToCart(token, cartProducts, allProducts, element._id, 1, { preventDuplicate: true })
//                 }
//               />
//             </Grid>
//           );
...
//       const cartItems = await axios.get(`${config.endpoint}/cart`, {
//         headers: {
//           'Authorization': `Bearer ${token}`,
//         },
//       });
//       const allpro = await axios.get(`${config.endpoint}/products`);

//       const completeCartItems = generateCartItemsFrom(cartItems.data, allpro.data);

//       setCartProducts(completeCartItems);
//     } catch (e) {
...
//     //   const newCartItems = await axios.post(
...
//     //   const newCart = await generateCartItemsFrom(newCartItems, allProducts);
...
//           }
//         );
//         const combinedData = await generateCartItemsFrom(sentData.data, allProducts)
//         setCartProducts(combinedData);
//       } catch (e) {
//         console.log(e);
//       }
//     }
...
//         <Grid
//           item
//           md={localStorage.getItem("username") ? true : 12}
//           sx={{ backgroundColor: "#E9F5E1", marginTop: "16px" }}
//         >
//           <Cart
//             items={cartProducts}
